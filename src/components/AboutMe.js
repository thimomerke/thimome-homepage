        ...
        <Container>
          ...
          <Row className="section-content">
            <Col className="about-text">
                <p>I'm an independent researcher, previously a graduate student of business at the {Parser(unima)} and {Parser(cbs)}.</p>
                <p>My main research interests are the techno-economic aspects of renewable energy, carbon removal and other energy-related topics. I also do some other, personal coding projects on the side.</p>
